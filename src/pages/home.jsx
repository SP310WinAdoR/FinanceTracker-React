            ...
            <div className='home-third-section_second-row'> 
              ...
              <div className='home-third-section_second-row_2card' > 
                ...
                <article className='cardTab_large'>
                  <h5> Lorem Ipsum </h5> 
                  <p> Lorem Ipsum fdfjds kasdjd sjfdsfjhfdsklm dkfjdsfkdjsf sdjfkls</p>
                 </article>
              </div>
            </div> 
        </section>
{/* Cuarta Sección */ }
        ...
        <section className="home-fourth-section"> 
          ...
          <h1 className='home-fourth-section_title'> Precios </h1> 
          <p className='home-fourth-section_descroption'>  Problems trying to resolve the conflict between 
            the two major realms of Classical physics: Newtonian mechanics </p>
          <div className='home-fourth-section_row'> 
           
              <CardPrice tipe="Free" description="Most calendars are designed 
                                                    for teams. Slate is designed 
                                                    for freelancers who want
                                                      a simple way " price="0"/> 
              
              <CardPrice tipe="Standart" description="Most calendars are designed 
                                                    for teams. Slate is designed 
                                                    for freelancers who want
                                                      a simple way " price="19"/> 
